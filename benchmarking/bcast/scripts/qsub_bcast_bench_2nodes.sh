...
BENCH_DIR="/home/qktttt/mpich/benchmarking/bcast/data"
...
source "${BENCH_DIR}/run_bcast_algorithm_sweep.sh"
...
echo "Running Bcast benchmark: nodes=2 total_ranks=${TOTAL_RANKS} ppn=${RANKS_PER_NODE} cpu_bind=${CPU_BIND}"
